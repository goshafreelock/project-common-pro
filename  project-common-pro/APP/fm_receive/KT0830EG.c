/*************************************************************************
//  File Name: KT0830EG.c
//  Function:  KT FM products driver for customer
//  Rev:       4.2
//  Date:      2010/04/10
//  Note:	   ALL the registers are automatically set to default value 
			   after the chip is powerd on or reset.
*************************************************************************/
#include "KT0830EG.h"
#include "iic.h"
...
@Note: u8 KT0830EG_ValidStop(u16 Frequency)
**************************************************************************/
