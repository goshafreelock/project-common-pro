...
#elif defined(IIC_GPIO_USE_P01_P26)
...
#elif defined(AMP_MODE_SELECT_PORT_USE_P27)
#define D_CLASS_AMP_GPIO_INIT()			P2DIR &= ~(BIT(7));P2PU |=BIT(7);
#define D_CLASS_AMP_HIGH()					P27=D_CLASS_LEVEL
#define D_CLASS_AMP_LOW()					P27=AB_CLASS_LEVEL
...
#define BT_NEXT_PORT_INIT() 		P0DIR &= ~(BIT(7));P0PU |=BIT(7);P07 =0
#define BT_NEXT_ON() 				P07=1
#define BT_NEXT_OFF() 				P07 =0

#define BT_PREV_PORT_INIT() 		P0DIR &= ~(BIT(4));P0PU |=BIT(4);P04 =0
#define BT_PREV_ON() 				P04=1
#define BT_PREV_OFF() 				P04 =0
