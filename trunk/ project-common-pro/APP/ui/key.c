...
{	
	...
	for(volt_tab_idx=0;volt_tab_idx<6;volt_tab_idx++){

		volt_reg=volt_reg+volt_tab[volt_tab_idx];
	}
	volt_tab_idx =0;
...
#elif defined(USE_IR_POWER_KEY_TO_POWER_OFF)||defined(USE_IR_LONG_POWER_KEY_TO_FAKE_POWER_OFF)				
